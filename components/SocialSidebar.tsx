  ...
  return (
    <aside className="fixed right-[18px] top-1/2 -translate-y-1/2 z-[900] hidden lg:flex flex-col gap-3">
      <a href="https://chat.whatsapp.com/E6EpNtevkj3HSSCc88NfUd" target="_blank" rel="noopener" aria-label="WhatsApp"
        className="flex items-center justify-center w-[34px] h-[34px] bg-blue rounded-full text-white hover:bg-blue-dark hover:scale-110 transition-all">
      ...
      <button onClick={() => {
        ...
        className="flex items-center justify-center w-[34px] h-[34px] bg-blue rounded-full text-white hover:bg-blue-dark hover:scale-110 transition-all border-none cursor-pointer">
