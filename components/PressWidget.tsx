...
export default function PressWidget() {
  ...
  return (
    <div className="fixed bottom-7 left-7 z-[9999] flex flex-col items-start gap-3">
      <AnimatePresence>
        {open && (
          <motion.div
      ...
      <AnimatePresence>
        {!open && (
          <motion.button
            ...
            className="w-[90px] h-[90px] bg-transparent border-none cursor-pointer flex items-center justify-center p-0 animate-newsFloat hover:scale-110 hover:-translate-y-1 transition-transform"
          ...
          >
            <Image src="/newspaper.png" alt="Press Coverage" width={90} height={90} className="w-full h-full object-contain" />
          </motion.button>
        )}
      </AnimatePresence>
    </div>
