...
export default function Founders() {
  return (
    <section className="relative bg-off-white py-[90px] px-10 text-center overflow-hidden">
      <motion.p
      ...
      />
      <motion.h2
        className="font-fraunces text-[3.2rem] font-bold text-blue-dark leading-[1.15] mb-3"
      ...
      <div className="flex justify-center gap-[60px] flex-wrap max-w-[900px] mx-auto relative z-10">
        {founders.map((f, i) => (
          <motion.div
            key={i}
            className="flex flex-col items-center w-[220px] hover:-translate-y-2 transition-transform duration-300"
